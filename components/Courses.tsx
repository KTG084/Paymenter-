          ...
          >
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button className="cursor-pointer px-4 py-1.5 text-sm font-semibold text-white bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-md hover:bg-white/20 hover:shadow-fuchsia-500/30 transition-all duration-300">
                  Enroll
                </button>
              </div>
            </div>
